...
#     remove_tags = [dict(name='section', attrs={'style': re.compile('box-sizing: border-box; background-color: rgb(255, 255, 255);')})]
    remove_tags_after =[dict(name='strong', string=u'收获微店'), dict(name='strong', string=u'长按识别二维码'),  
                        dict(name='strong', string=u'网上订阅')]
    remove_tags = [dict(name='strong', string=u'收获微店'), dict(name='strong', string=u'"中国邮政网上订阅《收获》双月刊"')]
